...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>tr', require('telescope.builtin').resume, '[T]elescope [R]esume')
          ...
          vim.keymap.set('i', '<C-x>', vim.lsp.buf.signature_help, { buffer = event.buf })
      ...
      require('lspconfig').lexical.setup {
        cmd = {
          '/Users/szykol/.local/share/nvim/mason/bin/lexical',
        },
...

  {
    ...
    --   vim.api.nvim_set_hl(0, 'WinSeparator', { fg = '#506477' })
    --   vim.api.nvim_set_hl(0, 'LspReferenceRead', { bg = '#506477' })
    --   vim.api.nvim_set_hl(0, 'LspReferenceWrite', { bg = '#506477' })
    --   vim.api.nvim_set_hl(0, 'LspReferenceText', { bg = '#506477' })
    -- end,
  },
